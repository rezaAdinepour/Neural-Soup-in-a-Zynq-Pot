...
design_libs=(xilinx_vip axi_infrastructure_v1_1_0 axi_vip_v1_1_15 processing_system7_vip_v1_0_17 xil_defaultlib xlconcat_v2_1_5)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../HelloWorld.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../HelloWorld.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/media/reza/_dev_sda1/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../HelloWorld.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../HelloWorld.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/media/reza/_dev_sda1/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_vip_v1_1_15 $vlogan_opts -sverilog +incdir+"../../../../HelloWorld.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../HelloWorld.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/media/reza/_dev_sda1/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../HelloWorld.gen/sources_1/bd/design_1/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_17 $vlogan_opts -sverilog +incdir+"../../../../HelloWorld.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../HelloWorld.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/media/reza/_dev_sda1/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../HelloWorld.gen/sources_1/bd/design_1/ipshared/6b2b/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../HelloWorld.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../HelloWorld.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/media/reza/_dev_sda1/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../bd/design_1/ip/design_1_processing_system7_0_0/sim/design_1_processing_system7_0_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xlconcat_v2_1_5 $vlogan_opts +v2k +incdir+"../../../../HelloWorld.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../HelloWorld.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/media/reza/_dev_sda1/Vivado/2023.2/data/xilinx_vip/include" \
